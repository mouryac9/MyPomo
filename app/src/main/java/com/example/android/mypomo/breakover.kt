 ...
 * Use the [breakover.newInstance] factory method to
...
class breakover : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding = DataBindingUtil.inflate<FragmentBreakoverBinding>(inflater,
    ...
    companion object {
         ...
         * @return A new instance of fragment breakover.
         */
