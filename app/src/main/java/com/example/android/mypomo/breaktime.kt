 ...
 * Use the [breaktime.newInstance] factory method to
...
class breaktime : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding = DataBindingUtil.inflate<FragmentBreaktimeBinding>(inflater,
    ...
    companion object {
         ...
         * @return A new instance of fragment breaktime.
         */
